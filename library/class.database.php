...

{
...

	{
		...
		$this->dbCon=mysqli_connect($this->db_host,$this->db_user,$this->db_pswd);
...

		{
			...
			if(!$db_select) { die("Database Select Failed : ".mysqli_error()); }
...

	{
...

		{
			...
			$sqlStr=mysqli_real_escape_string($sqlStr,$this->dbCon);
...

	{
...

		{
			...
			$this->setErMsg(mysqli_error(),mysqli_errno());
...

	{
...

		{
			...
			return mysqli_num_rows($this->recSet);
