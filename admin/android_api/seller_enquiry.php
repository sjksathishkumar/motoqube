...
$result_data = $db->getRows("select x.*, y.*,z.*,u.*,v.*,w.name as buyer,w.profile_image,x.bid_id,bid.amount,bid.return_days, bid.bid_status, bid.product_images,x.dateandtime as bookingdate From sp_bookings x 
...
if(count($result_data)>0){
	...
	foreach ($result_data as $key => $value) {
		...
		$arrResults["bid_id"]=$value["bid_id"];
