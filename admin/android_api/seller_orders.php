...
$result_data = $db->getRows("select x.*, y.*,z.*,u.*,v.*,w.name as buyer,w.profile_image,bid.amount,bid.return_days,bid.product_images From sp_bookings x 
	...
	Where x.seller_id='$seller_id' and bid.seller_id='$seller_id' and (bid.bid_status='1' or bid.bid_status='3')
