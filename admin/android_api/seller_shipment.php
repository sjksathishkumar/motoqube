...
$result_data = $db->getRows("select x.*, y.*,z.*,u.*,v.*,w.name as buyer,w.profile_image,bid.amount,bid.return_days, package_images, shipping_images From sp_bookings x 
	...
	Where x.seller_id='$seller_id' and x.status!='enquiry created' and x.status!='cancelled' and x.status !='returned' and (paid_amount is NOT NULL or paid_amount!=NULL or paid_amount!='') and (bid.bid_status='1' or bid.bid_status='3') and (x.status!='cancelled' and x.status!='cancel requested' and x.status!='returned' and x.status!='return requested')
