...
$result_data = $db->getRows("select x.*, y.*,z.*,u.*,v.*,w.name as buyer,w.profile_image,bid.amount,bid.return_days From sp_bookings x 
	...
	Where x.seller_id='$seller_id' and bid.seller_id='$seller_id' and (x.status='cancelled' or x.status='cancel requested' or x.status='returned' or x.status='return requested')
