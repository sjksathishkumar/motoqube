    ...
    <div class="container-fluid">
          <div class="row panel panel-default page-wrapper-panel">
            <div class="gradient-card-header">
                <h2 class="white-text mx-3">Subadmin</h2>
            </div>
        <div class="sp_add">
                  ...
                  <div class="panel-body">
                    <form method="post" id="content_add"   enctype="multipart/form-data">
                      <div class="col-md-3 top15">
                        ...
                        <input type="text" id="sub_name" name="sub_name" class="form-control" placeholder="Name" value="" required="">
                      </div>
                      <div class="col-md-3 top15">
                        <span class="badge-label info-color p-2">Mobile<span class="redstar">*</span></span>
                        <input type="number" id="sub_mobile" name="sub_mobile" class="form-control" placeholder="Mobile" value="" required="">
                      </div>
                      <div class="col-md-3 top15">
                        <span class="badge-label info-color p-2">Email</span><br/>
                         <input type="email" id="sub_email" name="sub_email" class="form-control" placeholder="Email" value="" required="">
                      </div>
                      <div class="col-md-3 top15">
                        <span class="badge-label info-color p-2">Address</span><br/>
                         <textarea id="sub_address" name="sub_address" class="form-control" placeholder="Address"></textarea>
                      </div>
                      <div class="col-md-3 top15">
                        <span class="badge-label info-color p-2">Username<span class="redstar">*</span></span><br/>
                         <input type="text" id="sub_username" name="sub_username" class="form-control" placeholder="Username" value="" required="">
                      </div>
                      <div class="col-md-3 top15">
                        <span class="badge-label info-color p-2">Password<span class="redstar">*</span></span><br/>
                        <input type="text" id="sub_password" name="sub_password" class="form-control" placeholder="Password" value="" required="">
                      </div>
            ...
            <div class="row">
                  <div class="panel-default">
                    <div class="panel-body">
                      <table id="subadmin_table" class="table table-striped table-hover" width="100%">
                        <thead>
                          <tr>
                            <th>Id</th>
                            <th>Name</th>   
...
<script type="text/javascript">
  ...
  $('#subadmin_table').dataTable({
    ...
    "serverSide": true,
    "bAutoWidth": false,
    "ajax": "ajax_table_load.php?action=subadmin_table",
    "dom": 'ldfrtip'
  });
});
