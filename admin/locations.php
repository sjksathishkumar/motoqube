		...
		<div class="container-fluid">
	        <div class="row panel panel-default page-wrapper-panel">
		        <div class="gradient-card-header">
		            <h2 class="white-text mx-3">Seller Locations List</h2>
		        </div>
				<div class="sp_add">
...
<script type="text/javascript">
  ...
  $('#location_table').dataTable({
    ...
    "serverSide": true,
    "bAutoWidth": false,
    "ajax": "ajax_table_load.php?action=location_table",
    "dom": 'ldfrtip',
    "stateSave": true,
  });
});
...
$(document).ready(function(e){
    $("#content_add").on('submit', function(e){
		...
		formData.append('action', 'insert_location');
        $.ajax({
            type: 'POST',
            url: 'ajax.php',
            data: formData,
...
//     type: 'POST',
//     url: 'ajax_load.php',
//     data: 'action=get_pincode&location='+location+'&district='+district+'&state='+state,
//     dataType: "json",
//     success: function(data){ 
//     if(data['status'] == 'success'){ 
//       $("select[name=location]").html(data["Data"]);
