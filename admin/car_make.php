		...
		<div class="container-fluid">
	        <div class="row panel panel-default page-wrapper-panel">
		        <div class="gradient-card-header">
		            <h2 class="white-text mx-3">Car Make</h2>
		        </div>
				<div class="sp_add">
		        ...
		        <div class="row">
	                <div class="panel-default">
	                  <div class="panel-body">
	                    <table id="car_make_table" class="table table-striped table-hover" width="100%">
	                      <thead>
	                        <tr>
	                          <th>Priority ID</th>   
	                          <th>Make</th>
...
<script type="text/javascript">
  ...
  $('#car_make_table').dataTable({
    ...
    "serverSide": true,
    "bAutoWidth": false,
    "ajax": "ajax_table_load.php?action=car_make_table",
    "dom": 'ldfrtip',
    "columnDefs": [
...
$(document).ready(function(e){
    $("#content_add").on('submit', function(e){
		...
		formData.append('action', 'insert_car_make');
        $.ajax({
            type: 'POST',
            url: 'ajax.php',
            data: formData,
    ...
    $("#edit_custom_form").on('submit', function(e){
        e.preventDefault();
		var formData = new FormData(this);
		formData.append('action', 'update_car_make');
        $.ajax({
            type: 'POST',
            url: 'ajax.php',
            data: formData,
