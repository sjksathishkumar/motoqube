		...
		<div class="container-fluid">
	        <div class="row panel panel-default page-wrapper-panel">
		        <div class="gradient-card-header">
		            <h2 class="white-text mx-3">Seller App Banner</h2>
		        </div>
				<div class="sp_add">
		        ...
		        <div class="row">
	                <div class="panel-default">
	                  <div class="panel-body">
	                    <table id="seller_banner_table" class="table table-striped table-hover" width="100%">
	                      <thead>
	                        <tr>
	                          <th>Id</th>   
	                          <th>Image</th>             
...
<script type="text/javascript">
  ...
  $('#seller_banner_table').dataTable({
    ...
    "serverSide": true,
    "bAutoWidth": false,
    "ajax": "ajax_table_load.php?action=seller_banner_table",
    "dom": 'ldfrtip'
  });
});
$(document).ready(function(e){
    $("#content_add").on('submit', function(e){
		...
		formData.append('action', 'insert_seller_banner');
        $.ajax({
            type: 'POST',
            url: 'ajax.php',
            data: formData,
