		...
		<div class="container-fluid">
	        <div class="row panel panel-default page-wrapper-panel">
		        <div class="gradient-card-header">
		            <h2 class="white-text mx-3">Bike Make</h2>
		        </div>
				<div class="sp_add">
		            ...
		            <div id="add_content" class="panel panel-default collapse">
                     ...
                     <form method="post" id="content_add"   enctype="multipart/form-data">
                      <div class="col-md-3 top15">
                        <span class="badge-label info-color p-2">Priority<span class="redstar">*</span></span>
                        <input type="number" id="priority" name="priority" class="form-control" placeholder="Priority" value="" required="">
                      </div>
                      <div class="col-md-3 top15">
		        ...
		        <div class="row">
	                <div class="panel-default">
	                  <div class="panel-body">
	                    <table id="bike_make_table" class="table table-striped table-hover" width="100%">
	                      <thead>
	                        <tr>
	                          <th>Priority ID</th>   
	                          <th>Make</th>
...
<script type="text/javascript">
  ...
  $('#bike_make_table').dataTable({
    ...
    "serverSide": true,
    "bAutoWidth": false,
    "ajax": "ajax_table_load.php?action=bike_make_table"
  });
});
$(document).on('click', '.btnTableEdit', function( event ) {
    ...
    $.ajax({
        url: 'ajax_load.php',
        type: 'POST',
        data: 'action=edit_bike_make&id='+value,
        dataType: 'html'
    })
    .done(function(data){
...
$(document).ready(function(e){
    $("#content_add").on('submit', function(e){
		...
		formData.append('action', 'insert_bike_make');
        $.ajax({
            type: 'POST',
            url: 'ajax.php',
            data: formData,
    ...
    $("#edit_custom_form").on('submit', function(e){
        e.preventDefault();
		var formData = new FormData(this);
		formData.append('action', 'update_bike_make');
        $.ajax({
            type: 'POST',
            url: 'ajax.php',
            data: formData,
