		...
		<div class="container-fluid">
	        <div class="row panel panel-default page-wrapper-panel">
		        <div class="gradient-card-header">
		            <h2 class="white-text mx-3">State Wise Popular Locations</h2>
		        </div>
				<div class="sp_add">
                      ...
                      <div class="col-md-4 top15">
                        ...
                        <select name="state" id="state" class="select2" required="">
		                  ...
		                  <div class="col-md-4 top15">
		                    ...
		                    <input type="text" id="popularlocation_state" name="popularlocation_state" class="form-control" placeholder="Popular Location" value="" required="">
		                  </div>
...
<script type="text/javascript">
  ...
  $('#location_table').dataTable({
    ...
    "serverSide": true,
    "bAutoWidth": false,
    "ajax": "ajax_table_load.php?action=popularlocation_state_table",
    "dom": 'ldfrtip'
  });
});
$(document).on('click', '.btnTableEdit', function( event ) {
    ...
    $.ajax({
        url: 'ajax_load.php',
        type: 'POST',
        data: 'action=edit_popularlocation_state&id='+value,
        dataType: 'html'
    })
    .done(function(data){
...
$(document).ready(function(e){
    $("#content_add").on('submit', function(e){
		...
		formData.append('action', 'insert_popularlocation_state');
        $.ajax({
            type: 'POST',
            url: 'ajax.php',
            data: formData,
    ...
    $("#edit_custom_form").on('submit', function(e){
        e.preventDefault();
		var formData = new FormData(this);
		formData.append('action', 'update_popularlocation_state');
        $.ajax({
            type: 'POST',
            url: 'ajax.php',
            data: formData,
